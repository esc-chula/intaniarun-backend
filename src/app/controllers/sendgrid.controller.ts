...
async function sendSampleFirstEmail(req: Request, res: Response) {
    try {
...
async function sendSampleBibNumberEmail(req: Request, res: Response) {
    try {
        const { firstName, lastName } = req.body;
        const user = await prisma.user.findFirst({
            where: {
...
export { sendSampleBibNumberEmail, sendSampleFirstEmail };
              ...
              : user.type === 'ACQUAINTANCE'
                ...
                : user.type === 'STUDENT'
                  ...
                  : user.type === 'CHULA'
                    ? 'ประชาคมจุฬาฯ'
                    : 'ประชาชนทั่วไป'
    }</td></tr><tr><td style="padding-right:16px">ระยะทางวิ่ง:</td><td style="padding-right:16px">${
        user.selectedPackage
    } กม.</td></tr><tr><td style="padding-right:16px">ขนาดเสื้อ:</td><td style="padding-right:16px">${
        user.shirtSize
